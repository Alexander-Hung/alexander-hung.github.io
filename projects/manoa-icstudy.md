...
1. The Landing Page and the overall design of the software.

    - Logo design
    - Navbar & footer
2. The code of the most functionality for Study Session:
...
3. User/Admin Home pages

    - All Study Session pages/Lists
    - Feedback list
    - Report List

4. Github.io Page manage

    - Layout and link 

5. Github repo manage
